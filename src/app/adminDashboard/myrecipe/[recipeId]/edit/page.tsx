...
const EditRecipe: React.FC = () => {
  ...
  // Proper typing for the Quill editor change handler
  const handleEditorChange = (content: string) => {
    setEditorContent(content);
  };

  // Proper typing for input change handler
  ...
  // Proper typing for form submit handler
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    try {
      await axios.put(
        `https://recipebackend-phi.vercel.app/api/recipes/myrecipe/${recipeId}`,
        {
          ...recipeData,
