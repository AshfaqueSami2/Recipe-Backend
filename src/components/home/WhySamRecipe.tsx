...
const WhySamRecipe = () => {
  ...
  <h2 className="mt-6 mb-10 text-3xl font-semibold tracking-wide text-gray-800 sm:text-6xl">Why Sam Recipe?</h2> 
  <div className="flex flex-col justify-between lg:flex-row lg:flex-wrap">
    <div className="mt-8 lg:mt-10 lg:w-1/2">
      <div className="flex flex-col items-start lg:pr-16">
        <div className="w-16">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink='http://www.w3.org/1999/xlink' x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xmlSpace='preserve'>
            ...
            <path fill="url(#SVGID_1_)" d="M404,215.8v94.4c0,8.5-1.2,16.9-3.7,25l-23.9,118.4H197.5c0,0-10.7-11.5-25.9-28.3        c-15.5-17.2-3.4-44.7,19.7-44.7h60.3c38.3,0,69.3-31.2,69.3-69.7V182c0-7.5,6.8-13.1,14.1-11.6l32.6,6.6        C396.4,184,404,205.4,404,215.8z"></path>
        ...
        <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi eligendi dolore ipsum.</p>
      </div>
    </div>
    <div className="mt-8 lg:mt-10 lg:w-1/2">
      <div className="flex flex-col items-start lg:pr-16">
        <div className="w-16">
          <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink='http://www.w3.org/1999/xlink'  x="0px" y="0px" viewBox="0 0 512 512" enable-background="new 0 0 512 512" xmlSpace='preserve' 
            ...
            <svg>
            <path fill="url(#SVGID_1_)" d="M370.9,244c0,81.4-66,147.5-147.5,147.5c-78.6,0-142.9-61.5-147.3-139.1c7.1-2.4,17.5-1.9,20.9,6.4        c19.7,47.5,54.5,82.5,103.5,90.2c41.7,6.6,69.3-9.4,82.8-24.8c38.9-44.6,42.5-137.4-58.3-190.1c-15.8-8.2-6.4-33.6,11.3-33.6h0.6        c10.9,0,21.5,1.1,31.8,3.1C328.1,122.8,370.9,178.4,370.9,244z"></path>
        ...
        <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sit ad tenetur sequi exercitationem eveniet.</p>
      </div>
    </div>
    <div className="mt-8 lg:mt-10 lg:w-1/2">
      <div className="flex flex-col items-start lg:pr-16">
        ...
        <h2 className="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl"><span className="mr-5 text-2xl">Personalize Your Learning</span><span className="border border-teal-300 bg-teal-200 py-px px-3 text-xs font-bold uppercase text-green-900">Premium</span></h2>
        <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem ipsum dolor, sit amet consectetur adipisicing elit. A adipisci molestiae vero esse..</p>
      </div>
    </div>
    <div className="mt-8 lg:mt-10 lg:w-1/2">
      <div className="flex flex-col items-start lg:pr-16">
        ...
        <h2 className="lg: mt-6 flex items-center text-base font-semibold tracking-wide text-gray-800 lg:mt-6 lg:text-2xl"><span className="mr-5 text-2xl">Build Real-World Projects</span><span className="border border-teal-300 bg-teal-200 py-px px-3 text-xs font-bold uppercase text-green-900">Premium</span></h2>
        <p className="lg: mt-1 text-sm tracking-normal text-gray-800 lg:mt-1 lg:text-xl">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odio impedit reiciendis optio deleniti odit illum nisi deserunt possimus..</p>
      </div>
    </div>
  </div>
</div>
